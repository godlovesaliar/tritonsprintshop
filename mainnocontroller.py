...
#title images
maintitle1 = pygame.image.load('assets/maintitle1.png')
maintitle2 = pygame.image.load('assets/maintitle2.png')
invent_bg = pygame.image.load('assets/inventorybase.png')


#level image
level_bg = pygame.transform.scale(pygame.image.load('assets/level.png'), (screen_width, screen_height))
sell_image = pygame.transform.scale(pygame.image.load('assets/sales/sellimage0.png'), (286,286))

tables = pygame.transform.scale(pygame.image.load('assets/tables.png'), (screen_width, screen_height)).convert_alpha()

chairs = pygame.transform.scale(pygame.image.load('assets/chairs.png'), (screen_width, screen_height))
...
object_filament = pygame.transform.scale(pygame.image.load('assets/items/printerfilament.png'), (128,128))
object_filament0 = pygame.transform.scale(pygame.image.load('assets/items/printerfilament0.png'), (128,128))
object_octopus = pygame.transform.scale(pygame.image.load('assets/items/octopus/octopus.png'), (128,128))
object_octopus0 = pygame.transform.scale(pygame.image.load('assets/items/octopus/octopus0.png'), (128,128))
object_benchy = pygame.transform.scale(pygame.image.load('assets/items/benchy/benchy.png'), (128,128))
object_benchy0 = pygame.transform.scale(pygame.image.load('assets/items/benchy/benchy0.png'), (128,128))
object_laptop = pygame.transform.scale(pygame.image.load('assets/items/laptop.png'), (128,128))
object_laptop0 = pygame.transform.scale(pygame.image.load('assets/items/laptop0.png'), (128,128))
object_hall_pass = pygame.transform.scale(pygame.image.load('assets/items/hall_pass.png'), (128,128))
object_hall_pass0 = pygame.transform.scale(pygame.image.load('assets/items/hall_pass0.png'), (128,128))
object_dragon = pygame.transform.scale(pygame.image.load('assets/items/dragon/dragon.png'), (128,128))
object_dragon0 = pygame.transform.scale(pygame.image.load('assets/items/dragon/dragon0.png'), (128,128))
object_tablefilament = pygame.transform.scale(pygame.image.load(f'assets/items/tablefilament/tablefilament5.png'), (128,128))
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.stamina = 100
        self.sprite = pygame.transform.scale(pygame.image.load('assets/sprites/BookerBase.png'), (256, 256)).convert_alpha()
...
table = Objects('Table',pygame.transform.scale(pygame.image.load('assets/tables.png'), (screen_width, screen_height)).convert_alpha(),pygame.Rect(400,650,350,450))
cart = Objects('Cart',pygame.transform.scale(pygame.image.load('assets/cart.png'), (256, 256)),pygame.Rect(-75,640,195,100))
prusa1 = Objects('Prusa1',pygame.transform.scale(pygame.image.load('assets/printers/prusa.png'), (112, 112)),pygame.Rect(365,282,16,64))
prusa2 = Objects('Prusa2',pygame.transform.scale(pygame.image.load('assets/printers/prusa.png'), (112, 112)),pygame.Rect(490,282,16,64))
prusa3 = Objects('Prusa3',pygame.transform.scale(pygame.image.load('assets/printers/prusa.png'), (112, 112)),pygame.Rect(608,282,16,64))
ender = Objects('Ender',pygame.transform.scale(pygame.image.load('assets/printers/ender.png'), (128, 128)),pygame.Rect(745,295,16,64))
ultimaker = Objects('Ultimaker',pygame.transform.scale(pygame.image.load('assets/printers/ultimaker.png'), (120, 120)),pygame.Rect(870,295,16,64))
tablefilament = Objects('Table Filament',pygame.transform.scale(pygame.image.load('assets/items/tablefilament/tablefilament5.png'), (128, 128)),pygame.Rect(650,630,128,128))
laptop = Objects('Laptop',pygame.transform.scale(pygame.image.load('assets/items/laptop.png'), (128,128)),pygame.Rect(0,450,128,128))
sell_rect = Objects('sell_rect','assets/items/laptop.png',pygame.Rect(175,350,64,64))
student = Objects('Student',pygame.transform.scale(pygame.image.load('assets/student1.png'), (256,256)),pygame.Rect(175,720,64,64))
student2 = Objects('Student2',pygame.transform.scale(pygame.image.load('assets/student2.png'), (256,256)),pygame.Rect(860,720,64,64))
hallpass = Objects('Hall Pass',pygame.transform.scale(pygame.image.load('assets/items/hall_pass.png'), (64,64)),pygame.Rect(400,600,64,64))
...
class Printers():
    def __init__(self):
        ...
        self.bench = 1
        self.benchimage = pygame.transform.scale(pygame.image.load(f'assets/items/benchy/benchy{self.bench}.png'), (40,40))
        self.octo = 1
        self.octoimage = pygame.transform.scale(pygame.image.load(f'assets/items/octopus/octopus{self.octo}.png'), (40,40))
        self.octo2 = 1
        self.octoimage2 = pygame.transform.scale(pygame.image.load(f'assets/items/octopus/octopus{self.octo2}.png'), (40,40))
        self.octo3 = 1
        self.octoimage3 = pygame.transform.scale(pygame.image.load(f'assets/items/octopus/octopus{self.octo3}.png'), (40,40))
        self.drago = 1
        self.dragoimage = pygame.transform.scale(pygame.image.load(f'assets/items/dragon/dragon{self.drago}.png'), (64,64))
...
def check_filament():
    ...
    if count.filamentcollide and invent.money >=10 and count.use == 8:
        if count.tablefilament >=1:
            ...
            invent.money -=10
            count.filamentround = math.floor(count.tablefilament)
            tablefilament.image = pygame.transform.scale(pygame.image.load(f'assets/items/tablefilament/tablefilament{count.filamentround}.png'), (128,128))
...
def check_sales():
    if pygame.sprite.collide_rect(player,sell_rect):
        ...
        sell_image = pygame.transform.scale(pygame.image.load(f'assets/sales/sellimage{count.saletype}.png'), (286,286))
...
def check_printers():
    ...
    if pygame.sprite.collide_rect(player,prusa1):
        if printers.prusa1 == False and invent.filament > 0 and printers.octo != 200:
            ...
            printers.octo=1
            invent.octopus +=1
            printers.octoimage = pygame.transform.scale(pygame.image.load(f'assets/items/octopus/octopus{printers.octo}.png'), (40,40))
        else:
    ...
    if pygame.sprite.collide_rect(player,prusa2):
        if printers.prusa2 == False and invent.filament > 0 and printers.octo2 != 200:
            ...
            printers.octo2=1
            invent.octopus +=1
            printers.octoimage2 = pygame.transform.scale(pygame.image.load(f'assets/items/octopus/octopus{printers.octo2}.png'), (40,40))
        else:
    ...
    if pygame.sprite.collide_rect(player,prusa3):
        if printers.prusa3 == False and invent.filament > 0 and printers.octo3 != 200:
            ...
            printers.octo3=1
            invent.octopus +=1
            printers.octoimage3 = pygame.transform.scale(pygame.image.load(f'assets/items/octopus/octopus{printers.octo3}.png'), (40,40))
        else:
    ...
    if pygame.sprite.collide_rect(player,ender):
        if printers.ender == False and invent.filament > 0 and printers.bench != 120:
            ...
            printers.bench=1
            invent.benchy +=1
            printers.benchimage = pygame.transform.scale(pygame.image.load(f'assets/items/benchy/benchy{printers.bench}.png'), (40,40))
        else:
    ...
    if pygame.sprite.collide_rect(player,ultimaker):
        if printers.ultimaker == False and invent.filament > 0 and printers.drago != 400:
            ...
            printers.drago=1
            invent.dragon +=1
            printers.dragoimage = pygame.transform.scale(pygame.image.load(f'assets/items/dragon/dragon{printers.drago}.png'), (64,64))
        else:
...
def print_anims():
    ...
    if printers.prusa1:
        ...
        if printers.prusacount >=20:
            printers.prusacount =1 
        prusa1.image = pygame.transform.scale(pygame.image.load(f'assets/printers/prusa/prusa{printers.prusacount}.png'), (112, 112))
        printers.octo += 1
    ...
    if printers.prusa2:
        ...
        if printers.prusacount2 >=20:
            printers.prusacount2 =1 
        prusa2.image = pygame.transform.scale(pygame.image.load(f'assets/printers/prusa/prusa{printers.prusacount2}.png'), (112, 112))
        printers.octo2 += 1
    ...
    if printers.prusa3:
        ...
        if printers.prusacount3 >=20:
            printers.prusacount3 =1 
        prusa3.image = pygame.transform.scale(pygame.image.load(f'assets/printers/prusa/prusa{printers.prusacount3}.png'), (112, 112))
        printers.octo3 += 1
    ...
    if printers.ender:
        ...
        if printers.endercount >=20:
            printers.endercount =1 
        ender.image = pygame.transform.scale(pygame.image.load(f'assets/printers/ender/ender{printers.endercount}.png'), (128, 128))
        printers.bench += 1
    ...
    if printers.ultimaker:
        ...
        if printers.ultimakercount >=20:
            printers.ultimakercount =1 
        ultimaker.image = pygame.transform.scale(pygame.image.load(f'assets/printers/ultimaker/ultimaker{printers.ultimakercount}.png'), (120, 120))
        printers.drago += 1
...
def player_handle_movement(keys_pressed,player): 
    ...
    if keys_pressed[pygame.K_a] and player.x - count.VEL > -90:  # LEFT
        player.idle = False
        ...
        if count.walk >= 8:
            count.walk = 1
        player_left = pygame.transform.scale(pygame.image.load(f'assets/sprites/Walk/left/SidewalkL{count.walk}.png'), (256, 256))
        player.sprite = player_left

    elif keys_pressed[pygame.K_d] and player.x + count.VEL < 850:  # RIGHT
        player.idle = False     
        ...
        if count.walk >= 8:
            count.walk = 1
        player_right = pygame.transform.scale(pygame.image.load(f'assets/sprites/Walk/right/SidewalkR{count.walk //1}.png'), (256, 256))
        player.sprite = player_right

    elif keys_pressed[pygame.K_w] and player.y - count.VEL > 310:  # UP
        player.idle = False
        player.direction = 'up'
        player.y -= count.VEL
        ...
        if count.walk >= 8:
            count.walk = 1
        player_back = pygame.transform.scale(pygame.image.load(f'assets/sprites/Walk/back/BookerBackWalk{count.walk //1}.png'), (256, 256))
        player.sprite = player_back
        count.showback = 1
        
    elif keys_pressed[pygame.K_s] and player.y + count.VEL < 600:  # DOWN
        player.idle = False
        ...
        if count.walk >= 8:
            count.walk = 1
        player_front = pygame.transform.scale(pygame.image.load(f'assets/sprites/Walk/front/BookerFrontWalk{count.walk //1}.png'), (256, 256))
        ...
        if player.direction == 'up' or player.direction == 'bidle':
            player_use = pygame.transform.scale(pygame.image.load(f'assets/sprites/use/back/BookerBackUse{count.use //1}.png'), (256, 256))
        elif player.direction == 'down' or player.direction =='filde':
            player_use = pygame.transform.scale(pygame.image.load(f'assets/sprites/use/front/BookerFrontUse{count.use //1}.png'), (256, 256))
        elif player.direction == 'left':
            player_use = pygame.transform.scale(pygame.image.load(f'assets/sprites/use/left/sideusel{count.use //1}.png'), (256, 256))
        else:
            player.direction = 'right'
            player_use = pygame.transform.scale(pygame.image.load(f'assets/sprites/use/right/sideuser{count.use //1}.png'), (256, 256))
        ...
        if player.direction == 'up':
            if count.idle >= 15:
                count.idle = 1
            player_idle = pygame.transform.scale(pygame.image.load(f'assets/sprites/idle/back/BookerBackIdle{count.idle //1}.png'), (256, 256))
        elif player.direction == 'down':
            if count.idle >= 60:
                count.idle = 1
            player_idle = pygame.transform.scale(pygame.image.load(f'assets/sprites/idle/front/BookerFrontIdle{count.idle //1}.png'), (256, 256))
        elif player.direction == 'left':
            if count.idle >= 60:
                count.idle = 1
            player_idle = pygame.transform.scale(pygame.image.load(f'assets/sprites/idle/left/sideidlel{count.idle //1}.png'), (256, 256))
        elif player.direction == 'right':
            if count.idle >= 60:
                count.idle = 1
            player_idle = pygame.transform.scale(pygame.image.load(f'assets/sprites/idle/right/sideidler{count.idle //1}.png'), (256, 256))
        else:
            if count.idle >= 60:
                count.idle = 1
            player_idle = pygame.transform.scale(pygame.image.load(f'assets/sprites/idle/front/BookerFrontIdle{count.idle //1}.png'), (256, 256))
...
def main_title(): 
    while count.menu: 
        ...
        clock.tick(8) 
        maintitle = pygame.transform.scale((pygame.image.load(f'assets/menu/mainmenu{count.title}.png')),(1024,768))
...
def loading(): 
    while count.loading: 
        ...
        clock.tick(FPS) 
        maintitle = pygame.transform.scale((pygame.image.load(f'assets/menu/loading{count.load}.png')),(1024,768))
        screen.blit(maintitle, (0, 0))
...
def get_ready():
    ...
    while count.readying:
        ...
        if count.readycount <10:
            getready = pygame.transform.scale(pygame.image.load('assets/getready.png'),(1024,768))
            screen.blit(getready,(0,0))
            pygame.display.flip()
        
        if count.readycount >=10 and count.readycount <20:
            getready3 = pygame.transform.scale(pygame.image.load('assets/getready3.png'),(1024,768))
            
            screen.blit(getready3,(0,0))
            pygame.display.flip()
        
        if count.readycount >=20 and count.readycount <30:
            getready2 = pygame.transform.scale(pygame.image.load('assets/getready2.png'),(1024,768))
            
            screen.blit(getready2,(0,0))
            pygame.display.flip()
        
        elif count.readycount >=30 and count.readycount <40:
            getready1 = pygame.transform.scale(pygame.image.load('assets/getready1.png'),(1024,768))
            
            screen.blit(getready1,(0,0))
            pygame.display.flip()
        
        elif count.readycount >=40 and count.readycount <50:
            getready0 = pygame.transform.scale(pygame.image.load('assets/getready0.png'),(1024,768))
...
def gameover():
    ...
    if count.gametime == 0:
        ...
        game.stop()
        timeup = pygame.transform.scale((pygame.image.load(f'assets/timeup.png')),(1024,768)) 
    ...
    while count.gameovering:
        ...
        clock.tick(FPS) 
        game_over = pygame.transform.scale((pygame.image.load(f'assets/menu/gameover{count.gameover}.png')),(1024,768)) 
        ...
        if count.gameover >=25:
            levelcleared = game_over = pygame.transform.scale((pygame.image.load(f'assets/levelcleared.png')),(1024,768)) 
            ...
            money = pygame.transform.scale(pygame.image.load('assets/items/coin.png'),(80,80))
            screen.blit(money, (780,440))
            buttons = pygame.transform.scale(pygame.image.load('assets/gameoverbuttons.png'),(1024,768))
...
def graphics():
    ...
    #draw_text('Game Timer'+str(count.gametime),count_font,BLACK,230,108)
    ...
    money = pygame.transform.scale2x(pygame.image.load('assets/items/coin.png'))
    ...
    if count.sale >= 250 and count.saletype == 0:
        opendoor = (pygame.transform.scale2x(pygame.image.load('assets/speech.png')))
        screen.blit(opendoor,(player.x-55,player.y-25))
    if player.y <=480:
        screen.blit(tables,(100,0))
        screen.blit(tablefilament.image,(590,600))
        if count.tablepass >=1:
    ...
    if count.student1 >= 500:
        speech_l = (pygame.transform.scale2x(pygame.image.load('assets/speechl.png')))
        screen.blit(speech_l,(270,550))
        screen.blit(student.image,(85,520))
    if count.student2 >= 350:
        
        speech_r = (pygame.transform.scale2x(pygame.image.load(f'assets/speechr{count.student2quote}.png')))  
        screen.blit(speech_r,(720,550))  
        screen.blit(student2.image,(780,520))
